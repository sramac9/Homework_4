...
## 2011
ma.path.2011a <- paste0("data/input/ma-star-ratings/2011/2011_Part_C_Report_Card_Master_Table_2011_04_20_star.csv")
...
ma.path.2011b <- paste0("data/input/ma-star-ratings/2011/2011_Part_C_Report_Card_Master_Table_2011_04_20_summary.csv")
...
ma.path.2012b <- paste0("data/input/ma-star-ratings/Part C 2012 Fall/2012_Part_C_Report_Card_Master_Table_2011_11_01_Summary.csv")
...
## 2013
ma.path.2013a <- paste0("data/input/ma-star-ratings/Part C 2013 Fall/2013_Part_C_Report_Card_Master_Table_2012_10_17_Star.csv")
...
ma.path.2013b <- paste0("data/input/ma-star-ratings/Part C 2013 Fall/2013_Part_C_Report_Card_Master_Table_2012_10_17_Summary.csv")
...
## 2014
ma.path.2014a <- paste0("data/input/ma-star-ratings/Part C 2014 Fall/2014_Part_C_Report_Card_Master_Table_2013_10_17_stars.csv")
...
ma.path.2014b <- paste0("data/input/ma-star-ratings/Part C 2014 Fall/2014_Part_C_Report_Card_Master_Table_2013_10_17_summary.csv")
...
## 2015
ma.path.2015a <- paste0("data/input/ma-star-ratings/2015 Fall/2015_Report_Card_Master_Table_2014_10_03_stars.csv")
...
ma.path.2015b <- paste0("data/input/ma-star-ratings/2015 Fall/2015_Report_Card_Master_Table_2014_10_03_summary.csv")
